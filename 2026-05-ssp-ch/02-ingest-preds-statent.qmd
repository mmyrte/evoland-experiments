...
Ingest STATENT full-time-equivalent employment by sector. Currently the historical
state only; projecting it to each SSP scenario's socioeconomic logic is open — see `TODO.md`.

```{r}
#| label: ingest-statent
library(evoland)
