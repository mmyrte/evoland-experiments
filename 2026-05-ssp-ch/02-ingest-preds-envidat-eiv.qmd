...
Ingest SPEEDMIND ecological-indicator-value predictors (continuous community-weighted
means) from EnviDat. The soil layers here are slated for replacement by the rsofun/SSPM
soil ingestion — see `TODO.md`.

```{r}
#| label: ingest-envidat-eiv
