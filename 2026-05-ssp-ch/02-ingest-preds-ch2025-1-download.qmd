...
Stage 1 of CH2025 climate ingestion: probe the reverse-engineered atlas URLs and
download the live netCDFs to the cache. Rationale (GWL structure) in
`2-ingest-preds-ch2025-todo.md`; URL patterns in `2-ingest-preds-ch2025-urls.md`.

```{r}
#| label: ch2025-download
