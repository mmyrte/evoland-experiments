...
that the transition model learns from. The raw data uses the NOAS04 nomenclature (72
...
>
> - **Bioregions** — ingest `ch.bafu.biogeographische_regionen` as a region-ID predictor.
...
are used later for aggregation and could in principle be left empty. The `static` class
