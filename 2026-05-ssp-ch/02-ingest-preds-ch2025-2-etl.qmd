...
Stage 2 of CH2025 climate ingestion: extract the cached netCDFs at the model
coordinates and load them as predictors. Observed (`-obs`) ingested at `id_period 0`;
projected `-gwl` deferred — see `TODO.md`.
