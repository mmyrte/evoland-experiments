...
# TODO filter to be sure this only ingests stuff that is also available into the future

# id_period 0 baseline takes a single reference period
inventory <- inventory[
  reference_period == obs_reference_period &
  time_of_year == "yearly" # the seasonal indicators aren't available for GWLs
]
