#' Purpose: ingest SonBase noise data
#' https://www.bafu.admin.ch/de/laerm-geodaten
...
db$add_predictor(
  ...
  sources = sources_sonbase[, .(url, md5sum)]
)
